...
import db, { query, getClient } from '../config/db';
...
export const getUserHistory = async (req: Request, res: Response) => {
  try {
    ...
    // Get user's pastes
    const pastesResult = await db.query(
